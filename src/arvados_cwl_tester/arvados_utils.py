...
class Result:
    def __init__(self, process: Process):
        ...
        self.collection = self.client.get_collection(self.process.output_uuid)
        self.data_hash = self.collection.portable_data_hash
    ...
    def files(self) -> dict:
        ...
        for file in self.collection.reader.all_files():
            outputs[file.name()] = {
                "size": file.size(),
                "basename": file.name(),
                "location": f"{self.data_hash}/{file.name()}",
            }
        return outputs
    ...
    def command(self) -> dict:
        """
        Create a list with all commandline arguments generated by arvados-cwl-runner.
        Arguments:
            process: class Process
        Returns:
            List containing commandline arguments
        """
